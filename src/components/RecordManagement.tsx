  ...
  const columns = [
    {
      ...
      dataIndex: 'id',
      key: 'id',
      render: (text: string) => <span className="record-id">{text.substring(0, 12)}...</span>,
      width: 120
    },
    {
      ...
      dataIndex: 'metadata',
      key: 'date',
      render: (meta: any) => formatDate(meta?.record_date),
      width: 120
    },
    {
    ...
    },
    {
      ...
      dataIndex: 'text',
      key: 'text',
      render: (text: string) => <span className="record-text">{truncateText(text)}</span>
    },
    {
